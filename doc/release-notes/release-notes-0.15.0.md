...
### Miscellaneous
- #9871 `be8ba2c` Add a tree sha512 hash to hodlcash commits (sipa)
...
- #9905 `01b7cda` [contrib] gh-hodlcash: Move second sha512 check to the end (MarcoFalke)
- #9880 `4df8213` Verify Tree-SHA512s in hodlcash commits, enforce sigs are not SHA1 (TheBlueMatt)
...
- #9984 `cce056d` devtools: Make github-hodlcash compute SHA512 from git, instead of worktree (laanwj)
...
- #9670 `bd9ec0e` contrib: github-hodlcash improvements (laanwj)
...
- #10486 `10e8c0a` devtools: Retry after signing fails in github-hodlcash (laanwj)
...
- #10786 `ca4c545` Add PR description to hodlcash commit in github-hodlcash.py (sipa)
