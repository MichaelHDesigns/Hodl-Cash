...
- #15869 Add settings hodlcash test to prevent regresssions (ryanofsky)
...
- #15643 contrib: Gh-hodlcash: include acks in hodlcash commit (MarcoFalke)
- #15838 scripts and tools: Fetch missing review comments in github-hodlcash.py (nkostoulas)
...
- #16130 Don't GPG sign intermediate commits with github-hodlcash tool (stevenroose)
- #16162 scripts: Add key for michael ford (fanquake) to trusted keys list (fanquake)
- #16201 devtools: Always use unabbreviated commit IDs in github-hodlcash.py (laanwj)
- #16112 util: Log early messages (MarcoFalke)
- #16223 devtools: Fetch and display ACKs at sign-off time in github-hodlcash (laanwj)
...
- #16625 scripts: Remove github-hodlcash.py (fanquake)
