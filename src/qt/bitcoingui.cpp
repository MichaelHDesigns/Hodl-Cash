...
void BitcoinGUI::createActions()
{
...
#ifdef ENABLE_WALLET
    masternodeAction = new QAction(platformStyle->MultiStatesIcon(":/icons/masternodes"), tr("&Masternodes"), this);
    ...
    openConfEditorAction = new QAction(platformStyle->SingleColorIcon(":/icons/edit"), tr("Open Wallet &Configuration File"), this);
    openConfEditorAction->setStatusTip(tr("Open configuration file"));
    openMNConfEditorAction = new QAction(platformStyle->SingleColorIcon(":/icons/edit"), tr("Open &Masternode Configuration File"), this);
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible HodlCash command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to HodlCash network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    if (walletModel->wallet().getLastCoinStakeSearchInterval() != 0)
    {
