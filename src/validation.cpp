...
{
    if (Params().NetworkIDString() == CBaseChainParams::MAIN) {
        if (nHeight >= 0 && nHeight <= 43201) { return 12.5 * COIN;
        } else if (nHeight > 43201 && nHeight <= 57601) { return 12.5 * COIN;
        } else if (nHeight > 57601 && nHeight <= 72001) { return 12.5 * COIN;
        } else if (nHeight > 72001 && nHeight <= 86401) { return 12.5 * COIN;
        } else if (nHeight > 86401 && nHeight <= 100801) { return 12.5 * COIN;
        } else if (nHeight > 100801 && nHeight <= 144001) { return 12.5 * COIN;
        } else if (nHeight > 144001 && nHeight <= 273601) { return 12.5 * COIN;
        } else if (nHeight > 273601 && nHeight <= 316801) { return 12.5 * COIN;
        } else if (nHeight > 316801 && nHeight <= 360001) { return 12.5 * COIN;
        } else if (nHeight > 360001 && nHeight <= 403201) { return 12.5 * COIN;
        } else if (nHeight > 403201 && nHeight <= 446401) { return 12.5 * COIN;
        } else if (nHeight > 446401 && nHeight <= 489601) { return 12.5 * COIN;
        } else if (nHeight > 489601 && nHeight <= 532802) { return 12.5 * COIN;
        } else if (nHeight > 532802 && nHeight <= 576003) { return 12.5 * COIN;
        } else if (nHeight > 576003 && nHeight <= 662404) { return 12.5 * COIN;
        } else if (nHeight > 662404 && nHeight <= 748805) { return 12.5 * COIN;
        } else if (nHeight > 748805 && nHeight <= 835206) { return 12.5 * COIN;
        } else if (nHeight > 835206 && nHeight <= 969127) { return 12.5 * COIN;
        } else if (nHeight > 969127 && nHeight <= 1098728) { return 12.5 * COIN;
        } else if (nHeight > 1098728 && nHeight <= 1228329) { return 12.5 * COIN;
        } else if (nHeight > 1228329 && nHeight <= 1357930) { return 12.5 * COIN;
        } else if (nHeight > 1357930 && nHeight <= 1487531) { return 12.5 * COIN;
        } else if (nHeight > 1487531 && nHeight <= 1660332) { return 12.5 * COIN;
        } else if (nHeight > 1660332 && nHeight <= 1833133) { return 12.5 * COIN;
        } else if (nHeight > 1833133 && nHeight <= 2049134) { return 12.5 * COIN;
        } else if (nHeight > 2049134 && nHeight <= 2265135) { return 12.5 * COIN;
        } else if (nHeight > 2265135 && nHeight <= 2481136) { return 12.5 * COIN;
        } else if (nHeight > 2481136 && nHeight <= 2697137) { return 12.5 * COIN;
        } else if (nHeight > 2697137 && nHeight <= 2956338) { return 12.5 * COIN;
        } else if (nHeight > 2956338 && nHeight <= 3215539) { return 12.5 * COIN;
        } else if (nHeight > 3215539 && nHeight <= 3474740) { return 12.5 * COIN;
        } else if (nHeight > 3474740 && nHeight <= 3733941) { return 12.5 * COIN;
        } else if (nHeight > 3733941 && nHeight <= 3993142) { return 12.5 * COIN;
        } else if (nHeight > 3993142 && nHeight <= 4338743) { return 12.5 * COIN;
        } else if (nHeight > 4338743 && nHeight <= 4684344) { return 12.5 * COIN;
        } else if (nHeight > 4684344 && nHeight <= 5029945) { return 12.5 * COIN;
        } else if (nHeight > 5029945 && nHeight <= 5314421) { return 12.5 * COIN;
        } else if (nHeight > 5314421 && nHeight <= 9999999) { return 12.5 * COIN;
      }
    } else {
      if (nHeight < 501) { return 12.5 * COIN;
...
bool CheckBlock(const CBlock& block, BlockValidationState& state, const Consensus::Params& consensusParams, bool fCheckPOW, bool fCheckMerkleRoot)
{
    ...
    // Store type as this will be referenced a few times
    bool isProofOfStake = !block.IsProofOfWork();

    // Check that the header is valid (particularly PoW).  This is mostly
    // redundant with the call in AcceptBlockHeader.
    if (!CheckBlockHeader(block, state, consensusParams, fCheckPOW && !isProofOfStake))
        return false;
    ...
    if (isProofOfStake && !block.vtx[0]->vout[0].IsEmpty())
    ...
    if (isProofOfStake && (block.GetBlockTime() > GetAdjustedTime() + MAX_FUTURE_BLOCK_TIME_POS)) {
    ...
    if (!isProofOfStake && (block.GetBlockTime() > GetAdjustedTime() + MAX_FUTURE_BLOCK_TIME)) {
